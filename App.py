...
#code run command streamlit run App.py 
###### Packages Used ######
...
st.set_page_config(
   page_title="AI Resume Analyzer Using NLP",
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="#" style="text-decoration: none; color: #021659;">Student Name</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="#" style="text-decoration: none; color: grey;">Student Name</a>
